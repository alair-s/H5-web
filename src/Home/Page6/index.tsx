  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto h-[calc(100vh-2rem)] w-full max-w-sm overflow-hidden rounded-[34px] bg-white shadow-[0_24px_60px_rgba(112,130,186,0.18)]">
        ...
        <motion.div
          className="absolute left-1/2 top-[6%] z-10 w-[74%] -translate-x-1/2"
        ...
        <motion.div
          className="absolute left-1/2 top-[17%] z-10 w-[22%] -translate-x-1/2"
        ...
        <motion.div
          className="absolute left-1/2 top-[28%] z-10 w-[64%] -translate-x-1/2 rounded-[22px] border-[6px] border-[#495474]/90 bg-white/72 p-2 shadow-[0_18px_34px_rgba(92,104,141,0.16)] backdrop-blur-md"
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          className="absolute inset-x-6 bottom-[18%] z-10 rounded-[26px] bg-white/78 px-4 py-3 text-sm leading-6 text-slate-600 shadow-[0_10px_30px_rgba(142,159,197,0.16)] backdrop-blur-md"
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
